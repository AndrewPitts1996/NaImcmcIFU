...
path = '/Users/erickaguirre/Desktop/NaI_MCMC_output/modfits/NGC4030_2.0_test_modfit_prior2/'
# fits file path
fits_paths = sorted(glob.glob(path+'NGC4030*'), key = sort_key1)
...
p8_1 = figure(title="Samples logN prior 3 range (14.0-16.5)", y_axis_label='lambda_red')
...
def update_data(attr):
    ...
    p8_1_update = figure(title="Samples logN prior2 range (14.0-16.5)", y_axis_label='lambda_red')
