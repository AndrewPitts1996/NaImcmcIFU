...
# directory path
path = '/Users/erickaguirre/Desktop/NaI_MCMC_output/NGC4030_2.0_test_prior4/'
# fits file path
...
p5 = figure(title='Na I Velocity Map',tools=tools1, plot_width=535, plot_height=480,toolbar_location="below")
...
p2.yaxis.axis_label = "Flux (1E-17 erg/s/cm^2/spaxel)"
...
NaI_spec = p6.step('data_wave', 'data_flux', source=source6,legend_label = 'DAP Flux',mode="center")
NaI_smodel = p6.line('data_wave', 'data_smod', source=source6,legend_label = 'DAP S.C. Model',color='orange')
